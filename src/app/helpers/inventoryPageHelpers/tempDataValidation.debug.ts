...
// a value/numeric comparison. Independent of applyDisplayOverrideRules,
// which only ever matches on Model prefix/suffix and mutates fields rather
// than dropping rows. Useful for one-off checks like "which rows have no
// Fiyat" or "which rows have a Depoloma over 256".
// ---------------------------------------------------------------------------
